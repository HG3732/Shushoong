...
CREATE TABLE "REVIEW_AVAILABLE" (
	"USER_ID"	VARCHAR2(20)		NOT NULL,
	"APPROVE_NO"	NUMBER(20)		NOT NULL,
    "REVIEW_COUNT"  NUMBER(5)   NOT NULL
);

COMMENT ON COLUMN "REVIEW_AVAILABLE"."USER_ID" IS '8~20자 사이의 회원 아이디';

COMMENT ON COLUMN "REVIEW_AVAILABLE"."APPROVE_NO" IS '결제 상태에 따라 부여되는 번호(우리가 직접 SEQ 만들어서 줌)';

ALTER TABLE "REVIEW_AVAILABLE" ADD CONSTRAINT "PK_REVIEW_AVAILABLE" PRIMARY KEY (
	"USER_ID",
	"APPROVE_NO"
);

ALTER TABLE "REVIEW_AVAILABLE" ADD CONSTRAINT "FK_MEMBER_TO_REVIEW_AVAILABLE_1" FOREIGN KEY (
	"USER_ID"
)
REFERENCES "MEMBER" (
	"USER_ID"
...
ALTER TABLE "REVIEW_AVAILABLE" ADD CONSTRAINT "FK_PAY_TO_REVIEW_AVAILABLE_1" FOREIGN KEY (
	"APPROVE_NO"
)
REFERENCES "PAY" (
	"APPROVE_NO"
