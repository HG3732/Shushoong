...
CREATE TABLE "HOTEL_REVIEW" (
	...
	"HOTEL_RESERVE_CODE"	VARCHAR2(50)		NOT NULL,
...
CREATE TABLE "AIRLINE_RESERVE_INFO" (
    ...
    "DEPART_DATE"   VARCHAR2(25) NOT NULL,
    "ARRIVAL_DATE"   VARCHAR2(25) NULL
);
...
CREATE TABLE "HOTEL_RESERVE" (
    ...
    "RESERVE_TIME" TIMESTAMP DEFAULT(SYSDATE) NOT NULL,
    "ROOM"  NUMBER(3)   DEFAULT 1   NOT NULL
);
...
CREATE TABLE "PASSENGER_INFO" (
	...
	"AIRLINE_RESERVE_CODE"	VARCHAR2(50)		NOT NULL,
...
CREATE TABLE "PAY" (
	...
	"HOTEL_RESERVE_CODE"	VARCHAR2(50)		NULL,
	"AIRLINE_RESERVE_CODE"	VARCHAR2(50)		NULL
);
...
alter table hotel_deleted
drop constraint PK_HOTEL_DELETED;
