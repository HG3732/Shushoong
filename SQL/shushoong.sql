...
ALTER TABLE "RESERVE_REQUEST" ADD CONSTRAINT "PK_RESERVE_REQUEST" PRIMARY KEY (
    "REQUEST", "HOTEL_RESERVE_CODE"
);

ALTER TABLE "RESERVE_REQUEST" ADD CONSTRAINT "FK_HOTEL_REQUEST_TO_RESERVE_REQUEST" FOREIGN KEY(
    "REQUEST"
)
REFERENCES "HOTEL_REQUEST" (
    "REQUEST"
);

ALTER TABLE "RESERVE_REQUEST" ADD CONSTRAINT "FK_HOTEL_RESERVE_TO_RESERVE_REQUEST" FOREIGN KEY(
    "HOTEL_RESERVE_CODE"
)
REFERENCES "HOTEL_RESERVE" (
    "HOTEL_RESERVE_CODE"
