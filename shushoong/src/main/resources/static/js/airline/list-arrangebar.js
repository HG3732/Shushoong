...
function setPriceRightValue() {
	...
	const [min, max] = [parseInt(_this.min), parseInt(_this.max)];
	const rightValue = parseInt(_this.value);
	document.querySelector(".middle-range.price .div2").innerText = rightValue;
...
function setPriceInitialValues() {
	const initialPriceRightValue = document.querySelector(".middle-range.price .div2").innerText;
